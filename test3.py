...
sbcenc = SubbandEncoder(sample_rate=sample_rate, num_bands=32, frame_size=CHUNK_SIZE // 6, f_min=4000, f_max=16000, resolution="int8")
sbcdec = SubbandDecoder(sample_rate=sample_rate, num_bands=32, frame_size=CHUNK_SIZE // 6, f_min=4000, f_max=16000, resolution="int8")
